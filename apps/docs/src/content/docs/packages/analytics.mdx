...
```bash
npm install @ccbd-seo/analytics @ccbd-seo/core
```

## Quick Start

```typescript
import { mergeGscWithAudit, analyzeTrend, analyzeQueryRankings } from '@ccbd-seo/analytics';
