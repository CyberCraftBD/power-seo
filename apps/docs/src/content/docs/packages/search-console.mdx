---
title: "@power-seo/search-console"
...
```typescript
import { createGSCClient, createTokenManager } from '@power-seo/search-console';
...
```typescript
import { listSitemaps, submitSitemap } from '@power-seo/search-console';
